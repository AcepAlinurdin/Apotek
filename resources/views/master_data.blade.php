<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    <form id="formObat">
                        ...
                        <div class="grid md:grid-cols-4 grid-cols-2 gap-4">
                            <div class="md:col-span-1">
                                ...
                                <input id="tanggal" name="tanggal" type="date" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input id="supplier" name="supplier" type="text" placeholder="Nama Supplier" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            </div>
                            <div class="md:col-span-1">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input id="harga_box" name="harga_box" type="number" placeholder="Contoh: 15000" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                            </div>
                        </div>
                ...
                <div class="mb-4">
                    <form action="{{ route('obat.master.index') }}" method="GET" class="flex items-center space-x-2">
                        <input type="text" name="search" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" placeholder="Cari berdasarkan Nama atau Kode Obat..." value="{{ $searchTerm ?? '' }}">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse border border-gray-300">
                        ...
                        <tbody id="tabelObat" class="text-gray-700 text-sm ">
                            ...
                            @empty
                                <tr><td colspan="9" class="text-center p-4">Belum ada data obat atau data tidak ditemukan.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
    ...
    @push('scripts')
    {{-- Memasukkan jQuery dan script khusus halaman ini ke dalam stack 'scripts' --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tabelObat').on('click', '.edit-btn', function() {
                ...
                $('#obat_id').val(id);
                $('#tanggal').val(tanggal);
                //  $('#kode_obat').val(row.find('td:eq(1)').text()); // Asumsi kode obat tidak di-edit
