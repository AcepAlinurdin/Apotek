<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="bg-gray-50 p-6 rounded-lg mb-8 border border-gray-200">
                    ...
                    <form id="formObat">
                        ...
                        <div class="grid md:grid-cols-4 grid-cols-2 gap-4">
                            ...
                            {{-- [MODIFIED] Input supplier diubah menjadi dropdown --}}
                            <div class="md:col-span-2">
                ...
                <div class="mb-4">
                    <form action="{{ route('obat.master.index') }}" method="GET" class="flex items-center space-x-2">
                        ...
                        <a href="{{ route('obat.master.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Reset
                        </a>
                    </form>
                </div>
    ...
    @push('scripts')
    {{-- Script AJAX Anda tidak perlu diubah karena sudah mengambil value berdasarkan teks --}}
    @endpush
</x-app-layout>
